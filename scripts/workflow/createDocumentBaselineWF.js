...
*
* Author: Jean-François Thibeault
* Version 20200731
...
{ */
  ...
  var currentdate = new java.util.Date().toString();

  var outFile = new java.io.FileWriter("./logs/main/createDocumentBaselineWF.log", false);
  var out = new java.io.BufferedWriter(outFile);
